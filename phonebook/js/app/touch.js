...
// patch for handling click events on touch devices.
// according to https://github.com/emberjs/ember.js/issues/605#issuecomment-6235280
        ...
        setupHandler: function(rootElement, event, eventName) {
            ...
            rootElement.delegate('.ember-view', event + '.ember', function(evt, triggeringManager) {
                ...
                switch(evt.type) {
                    ...
                    // Monitor touchmove in case user moves finger away and then back original point
                    case 'touchmove':
                        if (touch.start) {
